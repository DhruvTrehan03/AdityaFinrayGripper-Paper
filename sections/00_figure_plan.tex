...
\begin{figure}
    \centering
    \includesvg[width=\linewidth]{/home/dhruv/AdityaFinrayGripper/Paper/figures/Outline.svg}
    \caption{}
    \label{fig:placeholder}
\end{figure}
Overview of the proposed sensor, the two sensing
modalities, and the principal experimental evaluations. Dhruv

\item \textbf{Figure 2:}
\begin{figure}
    \centering
    \includesvg[width=\linewidth]{/home/dhruv/AdityaFinrayGripper/Paper/figures/SensorCharacterisation.svg}
    \caption{}
    \label{fig:placeholder}
\end{figure}
Sensor architecture and design, including the
